    ...
    return (
        <Wrapper $ratio={ratio}>
            ...
            <InfoBlock $ratio={ratio}>
                {
                    part === 0 ? (
                        <TextPartWrapper $ratio={ratio} $pt={130 * ratio}>
                        ...
                        <TextPartWrapper $ratio={ratio} $pt={190 * ratio}>
                            <p><b>Твоя миссия</b> — не найти, а изобрести идеальный карьерный трек под кодовым названием «X5». Используй наши наработки, цифровые прототипы и свою интуицию.</p>
                        </TextPartWrapper>
                    )
                }
            </InfoBlock>
