...
const Text = styled(motion.div)`
    ...
    left: var(--spacing_x3);
    max-width: calc(100% - var(--spacing_x6));
`;
...
const config = {
    part0: {
        component: () => (
            ...
            <path d="M78.5 244L24 244C10.7452 244 9.39372e-07 233.255 2.09815e-06 220L-1.12846e-05 24.0001C-1.01258e-05 10.7453 10.7451 0.000105572 24 7.62135e-05L59.304 3.35236e-05C68.749 1.90905e-05 77.3158 5.53969 81.191 14.1531L92.4561 39.1921C96.3312 47.8055 104.898 53.3452 114.343 53.3452L350 53.3452C363.255 53.3452 374 64.0904 374 77.3452L374 220C374 233.255 363.255 244 350 244L78.5 244Z" fill="#F7F7F7" fill-opacity="0.25"/>
            <path d="M350 243.5L24 243.5C11.0213 243.5 0.500001 232.979 0.500002 220L0.500019 24C0.500078 11.0213 11.0214 0.499998 24 0.499969L59.3037 0.499972C68.5519 0.499958 76.941 5.92442 80.7354 14.3584L92 39.3974C95.9559 48.1902 104.701 53.8456 114.343 53.8457L350 53.8457C362.979 53.8457 373.5 64.367 373.5 77.3457L373.5 220C373.5 232.979 362.979 243.5 350 243.5Z" stroke="white" stroke-opacity="0.2"/>
            </g>
            <defs>
        ...
        text: () => (
            <p>
                Прежде чем конструировать идеальный карьерный трек, познакомься с главным инструментом — Соединителем. Наша команда инноваторов тестировала новые подходы и оставила для тебя несколько готовых модулей. Не пропадать же добру! Это твой базовый набор для старта. Теперь твоя очередь творить!
            </p>        
        ),
        bottom: 196,
        width: 374,
        ...
        component: () => (
            <svg width="100%" height="100%" viewBox="0 0 348 244" fill="none" xmlns="http://www.w3.org/2000/svg">
                <foreignObject x="-80" y="-80" width="508" height="404"><Dialog2 xmlns="http://www.w3.org/1999/xhtml" /></foreignObject><g data-figma-bg-blur-radius="80">
                    <path d="M78.5 244L24 244C10.7452 244 9.39372e-07 233.255 2.09815e-06 220L-1.12846e-05 24.0001C-1.01258e-05 10.7453 10.7451 0.000107845 24 7.84865e-05L59.304 3.57966e-05C68.749 2.13635e-05 77.3158 5.53969 81.191 14.1531L92.4561 39.1921C96.3312 47.8056 104.898 53.3452 114.343 53.3452L324 53.3452C337.255 53.3452 348 64.0904 348 77.3452L348 220C348 233.255 337.255 244 324 244L78.5 244Z" fill="#F7F7F7" fill-opacity="0.25" />
                    <path d="M324 243.5L24 243.5C11.0213 243.5 0.500001 232.979 0.500002 220L0.500019 24C0.500078 11.0213 11.0214 0.5 24 0.499972L59.3037 0.499975C68.5519 0.499961 76.941 5.92442 80.7354 14.3584L92 39.3974C95.9559 48.1902 104.701 53.8456 114.343 53.8457L324 53.8457C336.979 53.8457 347.5 64.367 347.5 77.3457L347.5 220C347.5 232.979 336.979 243.5 324 243.5Z" stroke="white" stroke-opacity="0.2" />
                </g>
                <defs>
    ...
    part3: {
        ...
        text: () => (
            <p>
               Отличный вопрос! Я покопался в данных и выяснил: единственный способ найти идеальный карьерный трек «X5» — собрать все бизнес-юниты вместе. Как их найти, мы уже знаем, поэтому оставляю чек-лист, чтобы тебе было легче. Правда, часть элементов придётся искать самому. Следи за шкалой прогресса: КАЖДАЯ удачная комбинация приближает тебя к разблокировке трека «X5».В общем, ты понял задачу. Меня ждёт нетворкинг в режиме «вне сети». Удачи — ты справишься!                
            </p>
        ),
        bottom: 196,
        width: 357,
