...
const config = {
    part0: {
        component: () => (
            ...
            <path d="M78.5 244L24 244C10.7452 244 9.39372e-07 233.255 2.09815e-06 220L-1.12846e-05 24.0001C-1.01258e-05 10.7453 10.7451 0.000105572 24 7.62135e-05L59.304 3.35236e-05C68.749 1.90905e-05 77.3158 5.53969 81.191 14.1531L92.4561 39.1921C96.3312 47.8055 104.898 53.3452 114.343 53.3452L350 53.3452C363.255 53.3452 374 64.0904 374 77.3452L374 220C374 233.255 363.255 244 350 244L78.5 244Z" fill="#4A4F4A" fillOpacity="1"/>
            ...
            <defs>
            <clipPath id="bgblur_0_418_4507_clip_path" transform="translate(80 80)"><path d="M78.5 244L24 244C10.7452 244 9.39372e-07 233.255 2.09815e-06 220L-1.12846e-05 24.0001C-1.01258e-05 10.7453 10.7451 0.000105572 24 7.62135e-05L59.304 3.35236e-05C68.749 1.90905e-05 77.3158 5.53969 81.191 14.1531L92.4561 39.1921C96.3312 47.8055 104.898 53.3452 114.343 53.3452L350 53.3452C363.255 53.3452 374 64.0904 374 77.3452L374 220C374 233.255 363.255 244 350 244L78.5 244Z" fill="#4A4F4A"/>
            </clipPath></defs>
            </svg>
        ),
        text: () => (
    ...
    part2: {
        ...
        text: () => (
            <p>
                Простое правило: если Соединитель переполнен, скинь всё <b>в корзину</b>, нажав на неё. Не ищи в ней скрытый функционал. Предложение заменить её на «чёрную дыру» для инновационного апгрейда тимлид проигнорировал. Говорит: «Из соображений сохранения вселенной».
            </p>       
        ),
        bottom: 196,
        width: 382,
    ...
    part3: {
        component: () => (
            <svg width="100%" height="100%" viewBox="0 0 357 358" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <clipPath id="bgblur_0_418_4784_clip_path" transform="translate(80 79.9999)"><path d="M78.5 358L24 358C10.7452 358 9.39372e-07 347.255 2.09815e-06 334L-1.31838e-06 24.0001C-1.59608e-07 10.7453 10.7451 0.000122317 24 0.000123476L59.304 6.55273e-05C68.749 3.58355e-05 77.3159 5.53971 81.191 14.1531L92.4561 39.1922C96.3313 47.8056 104.898 53.3453 114.343 53.3453L333 53.3452C346.255 53.3452 357 64.0904 357 77.3452L357 334C357 347.255 346.255 358 333 358L78.5 358Z" fill="#4A4F4A"/>
                    </clipPath></defs>
